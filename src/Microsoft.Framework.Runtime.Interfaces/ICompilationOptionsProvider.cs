...
namespace Microsoft.Framework.Runtime
{
    ...
    /// </summary>
    [AssemblyNeutral]
    public interface ICompilationOptionsProvider
    {
        /// <summary>
        /// Returns the parsed <see cref="ICompilerOptions"/> for a project file specified by
        /// <paramref name="projectPath"/>.
        /// </summary>
        /// <param name="projectPath">Absolute path to <c>project.json</c> or the project directory containing
        /// the <c>project.json</c> file.</param>
        ...
        ICompilerOptions GetCompilerOptions(string projectPath, FrameworkName targetFramework, string configurationName);
    }
}